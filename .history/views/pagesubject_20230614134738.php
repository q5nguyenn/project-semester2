...
if(isset($_GET['breadcrumb']) && isset($_GET['breadcrumbChild'])){
	...
	$selectorBreadcrumbAndChild = "SELECT departments.*, faculties.name as faculties_name, FROM `departments` JOIN faculties ON faculties.id = '$getIdBreadcrumb' AND faculties.id = departments.faculty_id AND departments.id =  $getidbreadcrumbChild ORDER BY  ";
