...
$select_sale = "SELECT courses.*, users.name as teacher_name, users.thumbnail as teacher_thumbnail FROM `courses` JOIN users  ON courses.teacher_id = users.id AND ((courses.price - courses.discoun)) ORDER BY teacher_id DESC LIMIT 4";
?>
<!DOCTYPE html>
<html lang="en">
