...
if(isset($_GET['breadcrumb']) && isset($_GET['breadcrumbChild'])){
	...
	echo $getIdBreadcrumb;
	echo $getidbreadcrumbChild;
	die
	...
	echo "<pre>";
	print_r($arrayBreadcrumbAndChild);
	echo "</pre>";
	die();
}
?>
			...
			<div class="container">
				...
				<div class="row">
					<ul class="list-unstyled d-flex pt-3 pb-3 mb-0">
						...
						<?php 
						}elseif (isset($_GET['breadcrumb']) && isset($_GET['breadcrumbChild'])) {
		...
		<div class="container-fluid" style="background-color: #f5f5f5;">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-12">
						<div class="mt-3 mb-2">
							<p class="fw-bold" style="font-size: 22px;">Các khóa học Ngoại ngữ</p>
						</div>
					</div>
				</div>
