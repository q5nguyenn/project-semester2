...
if (isset($_POST['buttonCourseHot'])) {
	...
	JOIN users ON courses.teacher_id = users.id ORDER BY teacher_id DESC LIMIT 8";
	$query_mergeCourse = mysqli_query(openConnection(), $mergeCourse);
} elseif (isset($_POST['buttonCourseNew'])) {
	$getIdFaculty = $_GET['id'];
	$mergeCourse = "SELECT courses.*, departments.name as departments_name, users.name as users_name, users.thumbnail as users_thumbnail
	FROM `courses`JOIN departments ON departments.id = courses.department_id AND departments.faculty_id = $getIdFaculty
	JOIN users ON courses.teacher_id = users.id ORDER BY created_at DESC  LIMIT 8";
	$query_mergeCourse = mysqli_query(openConnection(), $mergeCourse);
} else {
	$getIdFaculty = $_GET['id'];
	$mergeCourse = "SELECT courses.*, departments.name as departments_name, users.name as users_name, users.thumbnail as users_thumbnail
			...
			<div class="container">
				...
				<div class="row">
					<ul class="list-unstyled d-flex pt-3 pb-3 mb-0">
						<li><a href="homepage.php" class="text-decoration-none text-black fw-bold" style="font-size: 16px;">Unica</a></li>
						<?php
						if (isset($_GET['id'])) {
						?>
							<li><a href="#" class="text-decoration-none text-black fw-bold" style="font-size: 16px;"><i class="bi bi-caret-right-fill" style="font-size: 12px;"></i>
		...
		<div class="container-fluid" style="background-color: #f5f5f5;">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="">
						<swiper-container class="mySwiper" navigation="true" keyboard="true" pagination="true" pagination-clickable="true" space-between="30" slides-per-view="4">
								...
								<swiper-slide>
									<a class="text-decoration-none text-black position-relative" href="#">
										<div class="card shadow bg-body rounded">
											<img src="../public<?php echo $array_querymergeCourse['thumbnail'] ?>" style="width: 100%; height: 149px; object-fit: cover;" class="card-img-top" alt="...">
						...
						<div class="col-12 list-product">
							...
							<a href="" class="d-flex text-decoration-none text-black">
								<div class="detail-course d-flex">
									<img class="img-responsive" src="../public/images/hoc-gioi-tieng-anh-toan-dien_m_1555572380.jpeg" alt="">
									...
									<div class="detain-course__content d-flex">
										...
										<div class="price-count-course-filter" style="text-align: right;">
											...
											<div class="price_sale text-decoration-line-through" style="color: #888; font-size: 14px;">600.000đ</div>
										</div>
									</div>
								</div>
