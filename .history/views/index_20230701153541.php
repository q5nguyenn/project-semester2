			...
			<div class="container">
				...
				<div class="row pt-5">
					<div class="col-lg-12 d-flex justify-content-between">
						...
						<a href="../database/searchController.php?keyword=&acset=pricelowtohight" class="float-right text-decoration-none text-black">Xem thêm</a>
					</div>
				</div>
				...
				<div class="row mt-3">
					...
					while ($list_faculties = mysqli_fetch_array($query_faculties)) {
						...
						<div class="col-2 mb-3">
							<a href="faculty.php?id=<?php echo $list_faculties['id'] ?>"
