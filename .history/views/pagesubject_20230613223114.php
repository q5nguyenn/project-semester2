...
if(isset($_GET['menuLanguage'])){
	...
	$selector_MenuLanguage = "SELECT * FROM faculties WHERE faculties.id = $getIdMenuLanguage ORDER BY id LIMIT 1";
			...
			<div class="container">
				...
				<div class="row">
					<ul class="list-unstyled d-flex pt-3 pb-3 mb-0">
						<li><a href="#" class="text-decoration-none text-black fw-bold"
								style="font-size: 16px;">Unica</a></li>
						<li><a href="#" class="text-decoration-none text-black fw-bold" style="font-size: 16px;"><i
									class="bi bi-caret-right-fill" style="font-size: 12px;"></i>Ngoại ngữ</a></li>
					</ul>
				</div>
