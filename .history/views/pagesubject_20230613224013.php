...
if(isset($_GET['menuLanguage'])){
	$getIdMenuLanguage = $_GET['menuLanguage'];
	$selector_MenuLanguage = "SELECT * FROM faculties WHERE faculties.id = '$getIdMenuLanguage' ";
	$query_MenuLanguage = mysqli_query(openConnection(),$selector_MenuLanguage);
	echo "<pre>";
	echo print_r($query_MenuLanguage);
	echo "</pre>";
	$array_MenuLanguage = mysqli_fetch_array($query_MenuLanguage);
	echo "<pre>";
	echo print_r($array_MenuLanguage);
	echo "</pre>";
}
?>
					...
					<ul class="list-unstyled d-flex pt-3 pb-3 mb-0">
						<li><a href="homepage.php" class="text-decoration-none text-black fw-bold"
								...
								<li><a href="#" class="text-decoration-none text-black fw-bold" style="font-size: 16px;"><i
									class="bi bi-caret-right-fill" style="font-size: 12px;"></i><?php echo $array_MenuLanguage['name'] ?></a></li>
					</ul>
				</div>
