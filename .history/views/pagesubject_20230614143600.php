				...
				<div class="row">
					<form action="" method="get">
						<ul class="d-flex list-unstyled nav-tab">
							<button name="buttonCourseHot active" style=" border: none; padding: 10px 15px; background: #fff; border-radius: 4px; margin-right: 2px;">
								<li>
							...
							<button name="buttonCourseNew" style=" border: none; padding: 10px 15px; background: #fff; border-radius: 4px; margin-right: 2px;">
								<li style="margin-right: 2px;"><a href="#" class="text-decoration-none"
										style="padding: 15px 20px; background: #fff; border-radius: 4px;">Khoá
										học mới</a>
								</li>
							</button>
						</ul>
