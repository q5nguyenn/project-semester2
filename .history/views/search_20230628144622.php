							...
							<div class="d-flex align-items-center u-hot-cate shadow-sm p-3 mb-5 bg-body rounded" style="background-color: #fff;">
								...
								<form action="" method="post">
									<ul class="d-flex list-unstyled m-0">
										<button name="studymore" class="p-0 btn background-none"><li><a href="project-semester2/views/layouts/search.php?keyword=<?php echo $keyword ?>&acset=studymore" class="text-decoration-none">Học nhiều nhất</a></li></button>
