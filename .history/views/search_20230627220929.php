<?php 
	...
	if ($query_searchProduct) {
		...
		if (isset($_GET['keyword']) && isset($_GET['acset'])) {
			$searchProduct = "SELECT courses.*, users.name as users_name, users.thumbnail as users_thumbnail 
							...
							<div class="d-flex align-items-center u-hot-cate shadow-sm p-3 mb-5 bg-body rounded" style="background-color: #fff;">
								...
								<form action="" method="post">
									<ul class="d-flex list-unstyled m-0">
										...
										<button name="votehigh" class="p-0 btn background-none"><li><a href="" class="text-decoration-none">Đánh giá cao</a></li></button>
										<button name="coursenew" class="p-0 btn background-none"><li><a href="" class="text-decoration-none">Mới nhất</a></li></button>
