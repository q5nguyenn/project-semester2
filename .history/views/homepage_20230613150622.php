								...
								<div class="card shadow bg-body rounded">
									...
									<div class="content-course">
										<h3 class="cart-course__title">
											<p><?php echo $list_topsale['name'] ?></p>
										</h3>
										<div class="namegv">
											<span style="float: left;"><?php $list_topsale['teacher_name'] ?></span>
											<span class="price-principal"><?php echo $list_topsale['price'] ?></span>
										</div>
									</div>
									<div class="price-count" style="clear: both;">
										...
										<span class="price-discount"><?php echo $list_topsale['discount'] ?></span>
									</div>
