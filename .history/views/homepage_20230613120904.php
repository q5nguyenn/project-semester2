...
$select_topsale = "SELECT * FROM courses,users WHERE courses.teacher_id = users.id ORDER BY teacher_id DESC";
$query_topsale = mysqli_query(openConnection(),$select_topsale);
$list_topsale mysqli_fetch_array($query_topsale);
echo "<pre>";
print_r($query_topsale);
echo "</pre>"
?>
<!DOCTYPE html>
<html lang="en">
