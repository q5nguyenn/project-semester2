...
$select_faculties = "SELECT * FROM faculties ORDER BY id DESC LIMIT 12";
				...
				<div class="row pt-3">
					...
					while ($list_startup = mysqli_fetch_array($query_starup)) {
						...
						<div class="col-lg-3 mb-4">
							<a class="text-decoration-none text-black position-relative" href="#">
								<div class="card shadow bg-body rounded">
									<img src="../public<?php echo $list_startup['thumbnail'] ?>" style="width: 100%;"
										class="card-img-top" alt="...">
				...
				<div class="row mt-3">
					...
					?>
						<div class="col-2 mb-3">
							<a href="#"
								class="bg-danger d-flex flex-column justify-content-center align-items-center pt-3 pb-3 bg-light shadow-sm bg-body rounded text-decoration-none text-black" style="font-size:23px;">
								<?php echo $list_faculties['icon']?>
								<span><?php echo $list_faculties ?></span>
							</a>
						</div>
					<?php 
						}
