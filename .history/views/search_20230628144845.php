							...
							<div class="d-flex align-items-center u-hot-cate shadow-sm p-3 mb-5 bg-body rounded" style="background-color: #fff;">
								...
								<form action="" method="post">
									<ul class="d-flex list-unstyled m-0">
										<button name="studymore" class="p-0 btn background-none"><li><a href="?keyword=<?php echo $keyword ?>&acset=studymore" class="text-decoration-none">Học nhiều nhất</a></li></button>
										<button name="votehigh" class="p-0 btn background-none"><li><a href="?keyword=<?php echo $keyword ?>&acset=votehight" class="text-decoration-none">Đánh giá cao</a></li></button>
										<button name="coursenew" class="p-0 btn background-none"><li><a href="?keyword=<?php echo $keyword ?>&acset=newstudy" class="text-decoration-none">Mới nhất</a></li></button>
										<button name="pricelowertohigh" class="p-0 btn background-none"><li><a href="?keyword=<?php echo $keyword ?>&acset=pricelowtohight" class="text-decoration-none">Giá thấp đến giá cao</a></li></button>
										<button name="pricehightolower" class="p-0 btn background-none"><li><a href="?keyword=<?php echo $keyword ?>&acset=pricehightolow" class="text-decoration-none">Giá cao đến giá thấp</a></li></button>
									</ul>
								</form>
							</div>
						</div>
