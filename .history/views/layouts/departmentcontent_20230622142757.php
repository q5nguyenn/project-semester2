<div class="row list-filter-course">
	<div class="col-4">
		<div class="filter-detail border-top">
			...
			<div>
				<label class="mb-3">
				<input type="radio" name="star_vote" class="star-rate mt-1" value='5' <?php if (isset($_GET['star_vote']) && $_GET['star_vote'] == '4') echo "checked"?>>
					<span class="star">
						<i class="bi bi-star-fill"></i>
						<i class="bi bi-star-fill"></i>
						<i class="bi bi-star-fill"></i>
			...
			<div>
				<label class="mb-3">
				<input type="radio" name="star_vote" class="star-rate mt-1" value='5' <?php if (isset($_GET['star_vote']) && $_GET['star_vote'] == '3') echo "checked"?>>
					<span class="star">
						<i class="bi bi-star-fill"></i>
						<i class="bi bi-star-fill"></i>
						<i class="bi bi-star-fill"></i>
