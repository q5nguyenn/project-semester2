...
<div class="row list-filter-course">
	...
	<div class="col-8">
		<div class="col-12 list-product">
			...
			?>
				<a href="" class="d-flex text-decoration-none text-black a">
		...
		<div class="col-12 pagination-course">
			...
			<?php 
					for ($i=1; $i <= $page; $i++) { 
				?>
				<li class="active"><a href="faculty.php?id=<?php echo $array_Faculty['id']?>&star_vote=<?php echo $_GET['filterStarCourse']?>&page=<?php echo $i ?>" data-page=""><?php echo $i ?></a></li>
				<?php 
					}
				?>
			</ul>
