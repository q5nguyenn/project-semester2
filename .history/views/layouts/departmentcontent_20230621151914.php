	...
	<div class="col-4">
		<div class="filter-detail border-top">
			...
			<div>
					...
					<label class="mb-3">
						<input type="radio" name="star_vote" class="star-rate mt-1" value='5'>
						<span class="star">
			...
			<div>
				<label class="mb-3">
					<input type="radio" name="star_vote" class="star-rate mt-1" value="4" <?php if (isset($_POST['star_vote	']) && $_POST['star_vote'] == "3") echo "checked"; ?>>
					<span class="star">
						<i class="bi bi-star-fill"></i>
						<i class="bi bi-star-fill"></i>
						<i class="bi bi-star-fill"></i>
