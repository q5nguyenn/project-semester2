...
<div class="row list-filter-course">
	<div class="col-4">
		<div class="filter-detail border-top">
			...
			<div>
			<form action="faculty.php?id=<?php echo $array_Faculty['id']?>" method="get">
			<input type="text" value="<?php echo $array_Faculty['id']?>" name="id" style="display:none">
					<label class="mb-3">
						<input type="radio" name="star_vote" class="star-rate mt-1" value='5' <?php if (isset($_POST['star_vote	']) && $_POST['star_vote'] == '5') echo "checked"; ?>>
						<span class="star">
			...
			<div>
				<label class="mb-3">
					<input type="radio" name="star_vote" class="star-rate mt-1" value="4" <?php if (isset($_POST['star_vote	']) && $_POST['star_vote'] == "4") echo "checked"; ?>>
					<span class="star">
						<i class="bi bi-star-fill"></i>
						<i class="bi bi-star-fill"></i>
						<i class="bi bi-star-fill"></i>
			...
			<div>
				<label class="mb-3">
					<input type="radio" name="star_vote" class="star-rate mt-1" value="3" <?php if (isset($_POST['star_vote	']) && $_POST['star_vote'] == "3") echo "checked"; ?>>
					<span class="star">
						<i class="bi bi-star-fill"></i>
						<i class="bi bi-star-fill"></i>
						<i class="bi bi-star-fill"></i>
