...
if(isset($_GET['breadcrumb']) && isset($_GET['breadcrumbChild'])){
	...
	$selectorBreadcrumbAndChild = "SELECT departments.*, faculties.name as faculties_name, faculties.id as faculties_id FROM `departments` JOIN faculties ON faculties.id = '$getIdBreadcrumb' AND faculties.faculties_id ";
}
?>
