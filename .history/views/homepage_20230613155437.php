			...
			<div class="container">
				...
				<div class="row pt-3">
					...
					while ($list_sale = mysqli_fetch_array($query_sale)) {
						$discount_sale = (($list_topsale['price'] - $list_topsale['discount']) / $list_topsale['price']) * 100;
						$round_discount_sale = round($discount);
						?>
						<div class="col-lg-3 mb-4">
							<a class="text-decoration-none text-black position-relative" href="#">
								<div class="card shadow bg-body rounded">
								...
								<div class="position-absolute top-0 start-0 text-center sale-price rounded">
									<p>-<?php echo $round_discount_sale.'%'?></p>
								</div>
							</a>
