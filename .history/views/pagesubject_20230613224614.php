...
if(isset($_GET['menuLanguage'])){
	$getIdBreadcrumb = $_GET['menuLanguage'];
	$selector_Breadcrumb = "SELECT * FROM faculties WHERE faculties.id = '$getIdMenuLanguage' ";
	$query_MenuList= mysqli_query(openConnection(),$selector_MenuLanguage);
	$array_MenuList = mysqli_fetch_array($query_MenuLanguage);
}
?>
