							...
							<div class="d-flex align-items-center u-hot-cate shadow-sm p-3 mb-5 bg-body rounded" style="background-color: #fff;">
								...
								<form action="" method="post">
									<ul class="d-flex list-unstyled m-0">
										...
										<button name="votehigh" class="p-0 btn background-none"><li><a href="searchController.php?keyword=<?php echo $keyword ?>&acset=voteh" class="text-decoration-none">Đánh giá cao</a></li></button>
