...
if (isset($_GET['filter'])&& $_GET['filter'] == 'morestudy') {
	...
	$query_mergeCourse_roi = mysqli_query(openConnection(), $mergeCourse);
}
					...
					<div class="col-8">
						<div class="d-flex align-items-center u-hot-cate justify-content-between">
							...
							<ul class="list-unstyled m-0">
								<li><a href="faculty.php?id=<?php echo $arrayQueryFaculties['id']?>&filter=morestudy" class="text-decoration-none">Học nhiều nhất</a></li>
								<li><a href="faculty.php?id=<?php echo $arrayQueryFaculties['id']?>&filter=highvote" class="text-decoration-none">Đánh gía cao</a></li>
								<li><a href="faculty.php?id=<?php echo $arrayQueryFaculties['id']?>&filter=newStudy" class="text-decoration-none">Mới nhất</a></li>
								<li><a href="faculty.php?id=<?php echo $arrayQueryFaculties['id']?>&filter=pricelowertohigh" class="text-decoration-none">Giá thấp đến cao</a></li>
								<li><a href="faculty.php?id=<?php echo $arrayQueryFaculties['id']?>&filter=pricehightolower" class="text-decoration-none">Giá cao đến thấp</a></li>
							</ul>
