...
$select_sale = "SELECT courses.*, users.name as teacher_name, users.thumbnail as teacher_thumbnail FROM `courses` JOIN users  ON courses.teacher_id = users.id AND ((courses.price - courses.discount)/courses.price)*100 > 50 ORDER BY teacher_id DESC LIMIT 4";
				...
				<div class="row pt-3">
					...
					while ($list_sale = mysqli_fetch_array($query_sale)) {
						...
						<div class="col-lg-3 mb-4">
							<a class="text-decoration-none text-black position-relative" href="#">
								<div class="card shadow bg-body rounded">
									<img src="../public/<?php echo $list_sale[''] ?>" style="width: 100%;"
										class="card-img-top" alt="...">
