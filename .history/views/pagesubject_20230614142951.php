				...
				<div class="row">
					<form action="" method="get">
						<ul class="d-flex list-unstyled nav-tab">
							<button name="buttonCourseHot"><li style="margin-right: 2px;"><a href="#" class="text-decoration-none active"
									style="padding: 15px 20px; color: #555555; background: #fff; border-radius: 4px;">Khoá
									học phổ biến</a></li>
							</button>
							<button name="buttonCourseNew" style="padding: 15px 20px; color: #555555; background: #fff; border-radius: 4px;">
