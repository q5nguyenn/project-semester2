										...
										<a class="text-decoration-none text-black position-relative" href="#">
											<div class="card shadow bg-body rounded">
												<img src="../public<?php echo $array_mergeCourse['thumbnail'] ?>"
													style="width: 100%; height: 149px; object-fit: cover;" class="card-img-top" alt="...">

												<div class="content-course">
													<h3 class="cart-course__title">
														<p><?php echo $array_mergeCourse['users_name']?></p>
													</h3>
													<div class="namegv">
														<span style="float: left;"><?php echo $array_mergeCourse['users_name']?></span>
														<span class="price-principal"><?php echo $array_mergeCourse['price']?></span>
													</div>
												</div>
												<div class="price-count" style="clear: both;">
													...
													<span class="price-discount"><?php echo $array_mergeCourse['discount']?></span>
												</div>
