<?php 
	...
	if ($query_searchProduct) {
		...
		if (isset($_GET['keyword']) && isset($_GET['acset'])) {
			$searchProduct =  "SELECT courses.*,  AVG(rate) as star, COUNT(bill_course.course_id) as bill_course, departments.name as departments_name, users.name as users_name, users.thumbnail as users_thumbnail
