...
if(isset($_GET['breadcrumb']) && isset($_GET['breadcrumbChild'])){
	...
	$selectorBreadcrumbAndChild = "SELECT departments.*, faculties.name as faculties_name FROM `departments` JOIN faculties ON faculties.id = departments.faculty_id AND faculties.id = '$getIdBreadcrumb' AND  departments.id =  $getidbreadcrumbChild ORDER BY faculty_id ";
...
if(isset($_POST['buttonCourseHot'])){
	$getIdBreadcrumb = $_GET['breadcrumb'];
	$mergeCourse = "SELECT courses.*, departments.name as departments_name, faculties.name as faculties_name "
}
?>
