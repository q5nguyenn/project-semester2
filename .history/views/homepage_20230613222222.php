	...
	<header>
		<div class="container-fluid shadow-sm">
			<div class="container d-flex py-1 align-items-center">
				...
				<div class="mx-3 position-relative" id="categories" style="z-index: 1;">
					<button class="btn">
						Categories <i class="bi bi-chevron-down"></i>
					</button>
					<div class="position-absolute bg-white p-1 rounded" id="department">
						<div class="p-2 btn"><i class="bi bi-translate me-2"></i><a href="pagesubject.php?languageId=1">Language</a></div>
