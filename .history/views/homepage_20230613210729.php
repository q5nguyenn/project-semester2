				...
				<div class="row mt-3">
					...
					?>
						<div class="col-2 mb-3">
							<a href="#"
								class="bg-danger d-flex flex-column justify-content-center align-items-center pt-3 pb-3 bg-light shadow-sm bg-body rounded text-decoration-none text-black" style="font">
