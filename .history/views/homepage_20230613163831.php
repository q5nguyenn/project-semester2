...
$select_starup = "SELECT courses.*,  users.name as teacher_name, users.thumbnail as teacher_thumbnail FROM `courses` JOIN users  ON courses.teacher_id = users.id JOIN departments ON courses.department_id = departments.id AND courses.department_id = 24 ORDER BY teacher_id  DESC LIMIT "
?>
<!DOCTYPE html>
<html lang="en">
						...
						<div class="col-lg-3 mb-4">
							<a class="text-decoration-none text-black position-relative" href="#">
								<div class="card shadow bg-body rounded">
									...
									<div class="content-course">
										<h3 class="cart-course__title">
											<p><?php echo $list_sale['name'] ?></p>
										</h3>
										<div class="namegv">
											<span style="float: left;"><?php echo $list_sale['teacher_name'] ?></span>
											<span class="price-principal"><?php echo $list_sale['price'] ?></span>
										</div>
									</div>
									<div class="price-count" style="clear: both;">
										<div class="rate-combo">
										...
										<span class="price-discount"><?php echo $list_sale['discount'] ?></span>
									</div>
								</div>
								<div class="position-absolute top-0 start-0 text-center sale-price rounded">
									<p>-<?php echo $round_discount .'%' ?></p>
